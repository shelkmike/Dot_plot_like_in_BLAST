...
For example, with the following setting the calculation will be faster than with default settings: "--minimum_percent_identity 80 --minimum_match_length 1000 --blast_tool_to_use megablast".
...
For example, here is an alignment and a corresponding diagram:<br>
